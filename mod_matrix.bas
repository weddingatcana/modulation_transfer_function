...
Public Function matInv(ByRef A#()) As Double()
    ...
    Dim rawMaxRowA&, _
        ...
        matInv = mod_matrix.extractIdentity(C)
...
Public Function matPin(ByRef A#()) As Double()
    ...
    Dim t#(), p#(), _
        ...
        t = mod_matrix.matTra(A)
        p = mod_matrix.matMul(t, A)
        V = mod_matrix.matInv(p)
        C = mod_matrix.matMul(V, t)
